...
parser.add_argument('--pitch', dest='pitch', action='store_true', help='modify pitch.')
parser.add_argument('--whitenoise', dest='whitenoise', action='store_true', help='modify whitenoise.')
...
#                                    momentum=args.momentum, nesterov=True)
    ...
    train_dataset = SpectrogramDataset(audio_conf=audio_conf, manifest_filepath=args.train_manifest, labels=labels,
                                       normalize=True, augment=args.augment,pitch = args.pitch, whitenoise = args.whitenoise)
    test_dataset = SpectrogramDataset(audio_conf=audio_conf, manifest_filepath=args.val_manifest, labels=labels,
                                      normalize=True, augment=False,pitch=False,whitenoise=False)
    ...
    print("More augumentation(pitch,whitenoise): ", args.pitch, args.whitenoise)
